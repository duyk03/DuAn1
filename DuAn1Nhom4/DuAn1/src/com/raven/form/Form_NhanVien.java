...
//        }
    ...
    public void sortMaNv() {
        Collections.sort(listNhanVien, (s1, s2) -> (s1.getMaNV().compareTo(s2.getMaNV())));
        showData(listNhanVien);
    }
    ...
    private void initComponents() {
        ...
        cbbSapXep.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tên A --> Z", "Lương Lớn --> Bé", "Mã Nv A --> Z", " " }));
